...
一款将古典音乐史知识问答、分支路线跑酷与古典音乐主题编曲结合的 HTML5 小游戏。玩家操控金色高音谱号，在限时关卡中沿不同路径跳上正确答案的平台。游戏从早期巴洛克延伸至晚期浪漫主义，共 9 关、每关 3 道题。
...
答案台位于路线终点，不能再从地面直接跳到。动态平台会先演示一个完整运动周期；预演完成后点击“开始跑酷”，倒计时才会启动。第三关起出现可见的升号障碍，碰撞后回到起点并扣除 3 秒，但不会直接判错。

## 古典音乐

九关分别使用浏览器实时合成的公版作品主题编曲，不需要下载外部音频：
...
5. 莫扎特《小夜曲》K.525
6. 贝多芬《第五交响曲》第一乐章
7. 肖邦《降E大调夜曲》Op.9 No.2
8. 瓦格纳《女武神的骑行》
9. 德沃夏克《自新大陆交响曲》第二乐章

主音量控制背景音乐，效果音量控制跳跃、落地、正确、错误和障碍提示音。暂停、切换标签页或退出关卡时音频会同步暂停或停止；答案解析期间音乐自动降低音量。
